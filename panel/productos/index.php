                ...
                <fieldset>
                  ...
                  <table class="table table-hover table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php print $c?></td>
                        <td width="170px"><?php print $item['nombre']?></td>
                        <td width="400px"><?php print $item['descripcion']?></td>
                        <td width="150px"><?php print $item['nomCategoria']?></td>
                        ...
                        <td class="text-center">
                        <a href="../acciones.php?id=<?php print $item['id'] ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
